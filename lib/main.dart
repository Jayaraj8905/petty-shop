...
import 'package:petty_shop/screens/shop_orders.dart';
    ...
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProxyProvider<Auth, Shops>(
            update: (ctx, auth, previousShops) => Shops(auth.token, auth.userId,
                previousShops == null ? [] : previousShops.list),
            create: (BuildContext context) {},
          ),
        ...
        child: Consumer<Auth>(
          builder: (ctx, auth, _) => MaterialApp(
            ...
            routes: {
              ...
              ShopOrders.routeName: (ctx) => ShopOrders()
            },
          ),
        ));
  }
